    ...
    <div>
        ...
        <dialog id={props.id} className="modal">
            <div className="modal-box bg-white rounded-2xl shadow-2xl border border-purple-100 p-8 max-w-md">
                ...
                <p className="py-4 text-gray-600 text-sm">{props.pid?._id}</p>
                <form method="dialog" onSubmit={handleSubmit(onSubmit)}>
                    <div className="space-y-5">
                        <label className="form-control w-full lg:max-w-xs px-2">
                            ...
                            <input type="text" placeholder="Type here" className="input input-bordered w-full lg:max-w-xs px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-500 cursor-not-allowed" disabled value={props.updateObj.index + 1} />
                        </label>
                        <label className="form-control w-full lg:max-w-xs px-2">
                            <div className="label mb-2">
                    ...
                    <div className="modal-action mt-8">
                        <div className="flex gap-3 w-full">
                            ...
                            <button className="btn mx-2 px-6 btn-sm btn-primary flex-1 bg-purple-600 hover:bg-purple-700 text-white font-medium py-3 rounded-lg transition-colors duration-200 shadow-sm border-none">Update</button>
                            <button className="btn mx-2 px-6 btn-sm flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-3 rounded-lg transition-colors duration-200 border-none" onClick={closeForm}>Cancel</button>
                        </div>
                    </div>
                </form>
            </div>
